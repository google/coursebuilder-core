...
#
# <application_id>: the application_id of your deployment, found in app.yaml.
...
#     command against. For dev, this is 'localhost:8081'. If you have a prod
#     deployment at foo.appspot.com, this is 'foo.appspot.com'.
#
# To download all course definition data:
#
#   sh scripts/etl.sh download course /<course_url_prefix> <application_id> \
#     <server> --archive_path <archive_path>
#
# To upload all course definition data:
#
#   sh scripts/etl.sh upload course /<course_url_prefix> <application_id> \
#     <server> --archive_path <archive_path>
#
# To download all datastore entities from a course:
#
#   sh scripts/etl.sh download datastore /<course_url_prefix> <application_id> \
#     <server> --archive_path <archive_path>
#
# To upload all datastore entities to a course:
#
#   sh scripts/etl.sh upload datastore /<course_url_prefix> <application_id> \
#     <server> --archive_path <archive_path>
#
# To download datastore entities of specific types from a course:
#
#   sh scripts/etl.sh download datastore /<course_url_prefix> <application_id> \
#     <server> --archive_path <archive_path> --datastore_types <datastore_types>
#
