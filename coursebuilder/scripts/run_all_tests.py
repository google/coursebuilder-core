...
ALL_TEST_CLASSES = {
    ...
    'tests.functional.common_users.AppEnginePassthroughUsersServiceTest': 6,
    ...
    'tests.functional.model_models.StudentTestCase': 6,
    ...
    'tests.functional.modules_data_removal.UserInteractionTests': 4,
    ...
    'tests.functional.modules_gitkit.GitkitServiceTest': 5,
    ...
    'tests.functional.modules_skill_map.SkillMapTests': 6,
