...
ALL_TEST_CLASSES = {
    ...
    'tests.functional.student_labels.StudentLabelsTest': 20,
    'tests.functional.student_tracks.StudentTracksTest': 5,
    ...
    'tests.functional.test_classes.CourseUrlRewritingTest': 40,
    'tests.functional.test_classes.DatastoreBackedCustomCourseTest': 5,
    'tests.functional.test_classes.DatastoreBackedSampleCourseTest': 40,
    ...
    'tests.functional.test_classes.MemcacheTest': 53,
    ...
    'tests.functional.test_classes.StudentAspectTest': 15,
    'tests.functional.test_classes.StudentUnifiedProfileTest': 15,
...
class FunctionalTestTask(object):
    ...
    def run(self):
        ...
        result, self.output = run(
            ['sh', test_sh, '--test_class_name %s' % self.test_class_name],
