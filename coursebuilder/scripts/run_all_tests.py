...
ALL_TEST_CLASSES = {
    ...
    'tests.functional.modules_invitation.ProfileViewInvitationTests': 4,
    ...
    'tests.functional.test_classes.MemcacheTest': 57,
    ...
    'tests.functional.test_classes.ImportActivityTests': 5,
