...
ALL_TEST_CLASSES = {
    ...
    'tests.functional.notifications_module.NotificationTest': 10,
    'tests.functional.notifications_module.PayloadTest': 6,
    'tests.functional.notifications_module.DatetimeConversionTest': 1,
    ...
    'tests.functional.student_labels.StudentLabelsTest': 30,
    'tests.functional.student_tracks.StudentTracksTest': 8,
    ...
    'tests.functional.test_classes.CourseUrlRewritingTest': 41,
    'tests.functional.test_classes.DatastoreBackedCustomCourseTest': 5,
    'tests.functional.test_classes.DatastoreBackedSampleCourseTest': 41,
    ...
    'tests.functional.test_classes.MemcacheTest': 54,
    ...
    'tests.functional.test_classes.StudentAspectTest': 16,
    'tests.functional.test_classes.StudentUnifiedProfileTest': 16,
    ...
    'tests.unit.common_schema_fields.FieldRegistryTests': 6,
