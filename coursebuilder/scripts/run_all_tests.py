...
ALL_TEST_CLASSES = {
    ...
    'tests.functional.modules_data_pump.PiiTests': 6,
    'tests.functional.modules_data_pump.BigQueryInteractionTests': 31,
    ...
    'tests.unit.javascript_tests.AllJavaScriptTests': 8,
