...
ALL_TEST_CLASSES = {
    ...
    'tests.functional.modules_notifications.CronTest': 8,
    'tests.functional.modules_notifications.DatetimeConversionTest': 1,
    'tests.functional.modules_notifications.ManagerTest': 21,
    ...
    'tests.functional.unit_assessment.UnitPrePostAssessmentTest': 11,
