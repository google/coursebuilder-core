...
ALL_TEST_CLASSES = {
    ...
    'tests.functional.test_classes.CourseUrlRewritingTest': 45,
    'tests.functional.test_classes.DatastoreBackedCustomCourseTest': 6,
    'tests.functional.test_classes.DatastoreBackedSampleCourseTest': 45,
    ...
    'tests.functional.test_classes.LegacyEMailAsKeyNameTest': 45,
    'tests.functional.test_classes.LessonComponentsTest': 3,
    'tests.functional.test_classes.MemcacheTest': 66,
    ...
    'tests.functional.test_classes.VirtualFileSystemTest': 45,
