...
ALL_TEST_CLASSES = {
    ...
    'tests.functional.modules_i18n_dashboard.TranslationImportExportTests': 3,
    ...
    'tests.functional.test_classes.InfrastructureTest': 14,
    'tests.functional.test_classes.I18NTest': 2,
    'tests.functional.test_classes.LessonComponentsTest': 2,
    'tests.functional.test_classes.MemcacheTest': 58,
    ...
    'tests.integration.test_classes': 17,
