...
ALL_TEST_CLASSES = {
    ...
    'tests.functional.modules_skill_map.SkillMapHandlerTests': 6,
    'tests.functional.modules_skill_map.SkillMapMetricTests': 6,
    'tests.functional.modules_skill_map.SkillMapTests': 3,
    'tests.functional.modules_skill_map.SkillListRestHandlerTests': 2,
    'tests.functional.modules_skill_map.SkillRestHandlerTests': 5,
    'tests.functional.modules_skill_map.StudentSkillViewWidgetTests': 4,
    ...
    'tests.functional.test_classes.CourseUrlRewritingTest': 43,
    'tests.functional.test_classes.DatastoreBackedCustomCourseTest': 6,
    'tests.functional.test_classes.DatastoreBackedSampleCourseTest': 43,
    ...
    'tests.functional.test_classes.MemcacheTest': 61,
