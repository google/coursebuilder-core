...
class RolesTest(actions.TestBase):
    ...
    # --------------------------- String-to-list.
    def test_site_admin_list_parsing(self):
        # pylint: disable-msg=protected-access
        self.assertListEqual(['foo'], roles.Roles._to_list('foo'))
        self.assertListEqual(['foo'], roles.Roles._to_list(' foo'))
        self.assertListEqual(['foo'], roles.Roles._to_list('foo '))
        self.assertListEqual(['foo'], roles.Roles._to_list(' foo '))
        ...
        self.assertListEqual(['foo'], roles.Roles._to_list('foo\n'))
        self.assertListEqual(['foo'], roles.Roles._to_list('\nfoo'))
        self.assertListEqual(['foo'], roles.Roles._to_list('\nfoo\n'))
        ...
        self.assertListEqual(['foo', 'bar'],
                             roles.Roles._to_list('foo\nbar\n'))
        self.assertListEqual(['foo', 'bar'],
                             roles.Roles._to_list('\nfoo\nbar\n'))
        self.assertListEqual(['foo', 'bar'],
                             roles.Roles._to_list('\n foo\n bar\n'))
        self.assertListEqual(['foo', 'bar'],
                             roles.Roles._to_list(' \n foo \n bar \n'))
